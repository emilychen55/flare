...
public class Flare extends Activity {
    ...
    public void addListenerOnButton() {
        //Select a specific button to bundle it with the action we want
        //Button wifiButton = (Button) findViewById(R.id.wifi_btn);
        Button onButton = (Button) findViewById(R.id.lightOn_btn);
        //Button offButton = (Button) findViewById(R.id.lightOff_btn);
